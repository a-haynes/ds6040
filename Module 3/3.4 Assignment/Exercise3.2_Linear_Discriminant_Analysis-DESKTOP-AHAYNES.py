...
class LDA:
    ...
    def compute_probabilities(self, x, priors):
        ...
        probabilities_sorted = np.argsort(likelihoods)[::-1]

        # print the predicted class and all class likelihoods
        print('LDA Predicted Class: ' + self.class_names[likelihood_sorted[0]])
        ...
        # print the predicted class and all class likelihoods
        print('LDA Most Probable Class: ' + self.class_names[probabilities_sorted[0]])
...
ob_b = [5.5, 3.1, 5, 1.5]
print("\n\nQuestion 4.a")
model_lda.compute_probabilities(ob_a, uninformative_priors)
print("\n\nQuestion 4.b")
model_lda.compute_probabilities(ob_b, uninformative_priors)
...
print("\n\nQuestion 5.a")
model_lda.compute_probabilities(ob_a, updated_priors)
print("\n\nQuestion 5.b")
model_lda.compute_probabilities(ob_b, updated_priors)
